...
"""
================================================================================
🧬 VQE Kitaev Chain - CUSTOMER VIEW TEST
================================================================================
...
Kitaev Chain:
- 6 qubits (sites)
- Hamiltonian: -μ ∑ n_j - t ∑ (c†_j c_{j+1} + h.c.) + Δ ∑ (c_j c_{j+1} + h.c.)
- Parameters: μ=0.5, t=1.0, Δ=1.0
...
def main():
    print("=" * 70)
    print("🧬 VQE Kitaev Chain - CUSTOMER VIEW TEST")
    print("=" * 70)
    print(f"Model: Kitaev Chain (6 sites, μ={MU}, t={T}, Δ={DELTA}) | Ground State: {EXACT_ENERGY:.4f} (computed)")
