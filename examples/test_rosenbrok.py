...
LR = 0.2
BOUNDS = (-5.0, 5.0)
FUNCTION = "rosenbrock"  # rosenbrock, sphere, ackley, beale
...
class LandscapeFunctions:
    ...
    def rosenbrock(x: np.ndarray) -> float:
        """Rosenbrock: classic valley-shaped function with a long, narrow, parabolic shaped flat valley"""
...
def main():
    ...
    functions = {
        ...
        'rosenbrock': LandscapeFunctions.rosenbrock,
    }
