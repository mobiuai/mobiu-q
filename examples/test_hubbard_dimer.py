...
"""
================================================================================
🧬 VQE Hubbard Dimer - CUSTOMER VIEW TEST
================================================================================
...
Hubbard Dimer:
- 4 qubits (2 sites × 2 spins)
- Hamiltonian: -t ∑_σ (c†_{1σ} c_{2σ} + h.c.) + U ∑_i n_{i↑} n_{i↓}
- Parameters: t=1.0, U=4.0
...
hamiltonian = SparsePauliOp.from_list([
    # Hopping terms for up spin (qubits 0-2)
    ("XIZI", T/2), ("YIZI", T/2), ("ZIYI", T/2), ("ZIXI", T/2),
    # Hopping terms for down spin (qubits 1-3)
    ("IZXI", T/2), ("IZYI", T/2), ("IYIZ", T/2), ("IXIZ", T/2),
    # On-site U for site 1 (qubits 0-1)
    ("IIZI", U/4), ("IIIZ", U/4), ("IIII", -U/4), ("IZII", -U/4),
    # On-site U for site 2 (qubits 2-3)
    ("ZIII", U/4), ("IZII", U/4), ("IIII", -U/4), ("IIZI", -U/4)
])
...
def main():
    print("=" * 70)
    print("🧬 VQE Hubbard Dimer - CUSTOMER VIEW TEST")
    print("=" * 70)
    print(f"Model: Hubbard Dimer (t={T}, U={U}) | Ground State: {EXACT_ENERGY:.4f} (computed)")
    ...
    with open('hubbard_dimer_customer_results.json', 'w') as f:
        json.dump({
            'model': 'Hubbard_Dimer',
