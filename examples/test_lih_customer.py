...
LiH (Lithium Hydride):
- 4 qubits
- Important for battery chemistry
- Tests Mobiu-Q on ionic bonding
================================================================================
"""
...
NUM_SEEDS = 5
NUM_SHOTS = 4096
C_SHIFT = 0.005  # Smaller shift for LiH
...
def main():
    print("=" * 70)
    print("🧬 VQE LiH - CUSTOMER VIEW TEST")
    print("=" * 70)
    print(f"Molecule: LiH (4 qubits) | Ground State: {EXACT_ENERGY} Ha")
    ...
    with open('lih_customer_results.json', 'w') as f:
        json.dump({
            'molecule': 'LiH',
