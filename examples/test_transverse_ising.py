...
"""
================================================================================
🧬 VQE Transverse Ising - CUSTOMER VIEW TEST
================================================================================
...
- 6 qubits (spins)
- Hamiltonian: -∑ (Z_i Z_{i+1}) - h ∑ X_i with h=1.0
...
# Transverse Ising Hamiltonian (6 qubits)
ops = []
...
def main():
    print("=" * 70)
    print("🧬 VQE Transverse Ising - CUSTOMER VIEW TEST")
    print("=" * 70)
    print(f"Model: Transverse Ising chain (6 spins, h={H_FIELD}) | Ground State: {EXACT_ENERGY:.4f} (computed)")
    ...
    with open('transverse_ising_customer_results.json', 'w') as f:
        json.dump({
            'model': 'Transverse_Ising',
